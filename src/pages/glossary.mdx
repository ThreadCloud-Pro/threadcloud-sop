...
| Role | Can do |
|---|---|
| **Owner** | Everything. There's exactly one — Gregory. |
...
- **Fly.io** — where ThreadCloud is hosted. Two apps: `threadcloud-staging` (testing) and `threadcloud-lite` (production).
- **Shopify Admin** — the store backend. ThreadCloud writes to it; you can read from it.
- **CodeRabbit** — automated code reviewer on GitHub. Not your concern.
