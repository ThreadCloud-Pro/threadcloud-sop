...
| **Buyer** | All workflows: Build Order, Enrich, Push, Receiving, Reorder, Custom orders, Merchandising, Financials. Can read settings but not change AI prompts or theme. |
...
| Manager doing reorders | Buyer | Needs to operate Reorder + Merchandising |
...
- Set up new brands with custom-order recipes
