...
Once at install — Gregory has already configured this for blazerformen.com. Re-visit only when changing theme or adding new filter facets.
</div>
...
This is a code change. Out of scope for the team — only Gregory does this.
...
The tabs themselves are theme metaobjects — managed by Gregory in Shopify Admin → Online Store → Themes → Customize. Out of scope for the team.
