...
Once at install time — Gregory has already run this for the Blazer For Men catalog (4984 products, classified May 2026). Re-run after big bulk imports of legacy products from another tool.
</div>
