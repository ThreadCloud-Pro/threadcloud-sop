...
ThreadCloud doesn't auto-place reorders. Every reorder is a manual decision. (Auto-reorder timers are on the roadmap but not built yet — Gregory will configure when they ship.)
